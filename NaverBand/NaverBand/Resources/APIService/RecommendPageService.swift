...
struct RecommendPageService {
    ...
    func recPage(completion: @escaping (NetworkResult<Any>) -> Void) {
        let header: HTTPHeaders = ["Content-Type": "application/json"]
        
        let dataRequest = Alamofire.request(APIConstants.recPageURL, method: .get, encoding: JSONEncoding.default, headers: header)
