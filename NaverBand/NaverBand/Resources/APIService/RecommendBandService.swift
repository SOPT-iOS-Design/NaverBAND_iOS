...
struct RecommendBandService {
    ...
    func recBand(completion: @escaping (NetworkResult<Any>) -> Void) {
        let header: HTTPHeaders = ["Content-Type": "application/json"]
        
        let dataRequest = Alamofire.request(APIConstants.recBandURL, method: .get, encoding: JSONEncoding.default, headers: header)
